...
export const realtimeEventSchema = z.discriminatedUnion("type", [
  ...
  z.object({ ...envelope, type: z.literal("itinerary.item.created"), payload: z.object({ itemId: z.string().uuid() }) }),
  z.object({ ...envelope, type: z.literal("itinerary.item.updated"), payload: z.object({ itemId: z.string().uuid() }) }),
  z.object({ ...envelope, type: z.literal("itinerary.item.deleted"), payload: z.object({ itemId: z.string().uuid() }) }),
  z.object({ ...envelope, type: z.literal("expense.changed"), payload: z.object({ expenseId: z.string().uuid() }) }),
  z.object({ ...envelope, type: z.literal("settlement.changed"), payload: z.object({ settlementId: z.string().uuid() }) }),
  z.object({ ...envelope, type: z.literal("place.changed"), payload: z.object({ placeId: z.string().uuid() }) }),
